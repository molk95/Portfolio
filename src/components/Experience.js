...
const ExpTitle = ({ title }) => {
  return <h3 className="font-weight-bold text-white">{title}</h3>;
};

const Experience = () => {
  return (
    <Row
      className="font-weight-bold py-5 px-3"
      style={{ backgroundColor: "#4c6d86", color: "#BBD2FF" }}
    >
